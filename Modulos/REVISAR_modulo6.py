...
def diagRH(A,tol=1e-15,K=1000):
    ...
    if n == 2:
        S = Hv1
        D = multiplicacionMatricial(multiplicacionMatricial(Hv1,A),traspuesta(Hv1))   # Hv1 @ A @ Hv1.T
    else:
        B = multiplicacionMatricial(multiplicacionMatricial(Hv1,A),traspuesta(Hv1))   # Hv1 @ A @ Hv1.T
        A_moño = B[1:, 1:]
